...
export class YearlyComponent implements OnInit , OnDestroy {
   loading: boolean = false;
      ...
      loadDataFromsessionStorage() {
        this.storedData = sessionStorage.getItem(`TorrentyearlyData-${this.selectedYear}`);
      ...
      loaddatayear() {
        ...
        this.subscribe = this.dataservice.getData_consumption_Yearly(this.selectedYear).subscribe((data: TestingDatayear) => {
          ...
          const storedData = JSON.parse(sessionStorage.getItem(`TorrentyearlyData-${this.selectedYear}`) || 'null');
          ...
          this.storedData = sessionStorage.setItem(`TorrentyearlyData-${this.selectedYear}`, JSON.stringify(data));
