...
@Component({
  ...
  standalone: true,
  imports: [DeviceComponent,DailyComponent,YearlyComponent,MAPComponent, DgstatusComponent, CommonModule, TotalrechargeComponent,SeperateDataComponent,],
  templateUrl: './project4.component.html',
  styleUrl: './project4.component.scss'
})
export class Project4Component implements OnInit,OnDestroy {
  public componentName: string = 'torrent';
