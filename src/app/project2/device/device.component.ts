...
export class DeviceComponent implements OnInit, OnDestroy {
  ...
  fetchAllData(initial_load: boolean): void {
    ...
    this.subscriptions.push(
      this.dataService.getAllData().subscribe((response: any) => {
        ...
        sessionStorage.setItem('NPCLsiteData', JSON.stringify(this.siteValues));
        ...
        sessionStorage.setItem('NPCLdataloggerData', JSON.stringify(this.dataloggerValues));
        ...
        sessionStorage.setItem('NPCLsensorData', JSON.stringify(this.sensorValues));
        ...
        sessionStorage.setItem('NPCLdicData', JSON.stringify(this.dicValues));
  ...
  handleButtonClick(chartType: string) {
    ...
    const data = JSON.parse(sessionStorage.getItem('NPCL'+chartType + 'Data')!);
