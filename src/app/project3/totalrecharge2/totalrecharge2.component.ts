import { ChangeDetectorRef, Component, EventEmitter, HostListener, Inject, OnDestroy, OnInit, PLATFORM_ID } from '@angular/core';
...
@Component({
  selector: 'app-totalrecharge2',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './totalrecharge2.component.html',
  styleUrl: './totalrecharge2.component.scss'
})
export class Totalrecharge2Component implements OnInit, OnDestroy {
  GridData!: any;
  DGData!: any;
