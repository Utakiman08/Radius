...
export class DeviceComponent implements OnInit, OnDestroy {
  ...
  fetchAllData(initial_load: boolean): void {
    ...
    this.subscriptions.push(
      this.dataService.getAllData().subscribe((response: any) => {
        ...
        sessionStorage.setItem('PVVNLsiteData', JSON.stringify(this.siteValues));
        ...
        sessionStorage.setItem('PVVNLdataloggerData', JSON.stringify(this.dataloggerValues));
        ...
        sessionStorage.setItem('PVVNLsensorData', JSON.stringify(this.sensorValues));
        ...
        sessionStorage.setItem('PVVNLdicData', JSON.stringify(this.dicValues));
  ...
  handleButtonClick(chartType: string) {
    ...
    const data = JSON.parse(sessionStorage.getItem('PVVNL'+chartType + 'Data')!);
