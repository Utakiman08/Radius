...
@Component({
  selector: "app-pyearly",
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: "./pyearly.component.html",
  styleUrl: "./pyearly.component.scss"
})
export class PyearlyComponent implements OnInit , OnDestroy {
  loading: boolean = false;
    ...
    loadDataFromsessionStorage() {
      this.storedData = sessionStorage.getItem(`PVVNLyearlyData-${this.selectedYear}`);
    ...
    loaddatayear() {
      ...
      this.subscribe = this.dataservice.getData_consumption_Yearly(this.selectedYear).subscribe((data: TestingDatayear) => {
        ...
        const storedData = JSON.parse(sessionStorage.getItem(`PVVNLyearlyData-${this.selectedYear}`) || 'null');
        ...
        this.storedData = sessionStorage.setItem(`PVVNLyearlyData-${this.selectedYear}`, JSON.stringify(data));
