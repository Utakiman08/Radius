...
export class DeviceComponent implements OnInit, OnDestroy {
  ...
  fetchAllData(initial_load: boolean): void {
    ...
    this.subscriptions.push(
      this.dataService.getAllData().subscribe((response: any) => {
        ...
        sessionStorage.setItem('AMRsiteData', JSON.stringify(this.siteValues));
        ...
        sessionStorage.setItem('AMRdataloggerData', JSON.stringify(this.dataloggerValues));
        ...
        sessionStorage.setItem('AMRsensorData', JSON.stringify(this.sensorValues));
        ...
        sessionStorage.setItem('AMRdicData', JSON.stringify(this.dicValues));
  ...
  handleButtonClick(chartType: string) {
    ...
    const data = JSON.parse(sessionStorage.getItem('AMR'+chartType + 'Data')!);
