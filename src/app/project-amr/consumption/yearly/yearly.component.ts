...
import { TestingDatayear, yeardg, yeargrid } from '../data.model';
import * as Highcharts from 'highcharts';
import { FormsModule } from '@angular/forms';
import { skip, Subscription, timer } from 'rxjs';
import { IntervalService } from '../../../interval.service';
@Component({
  selector: 'app-yearly-amr',
  standalone: true,
...
export class YearlyComponent implements OnInit , OnDestroy {
     loading: boolean = false;
        ...
        loadDataFromsessionStorage() {
          this.storedData = sessionStorage.getItem(`AMRyearlyData-${this.selectedYear}`);
        ...
        loaddatayear() {
          ...
          this.subscribe = this.dataservice.getData_consumption_Yearly(this.selectedYear).subscribe((data: TestingDatayear) => {
            ...
            if (this.storedData) {
              storedData = JSON.parse(sessionStorage.getItem(`AMRyearlyData-${this.selectedYear}`) || 'null');
            }
            ...
            this.storedData = sessionStorage.setItem(`AMRyearlyData-${this.selectedYear}`, JSON.stringify(data));
